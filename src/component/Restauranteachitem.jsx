                ...
                props.eachcard.title.card.card.itemCards.map(({ card: { info } }) => (
                    <div className=' flex justify-between items-center border-b-2 pb-4 pt-2 my-1' key={info.id}>
                        ...
                        <div className='text-center relative'>
                            ...
                            <button className='absolute left-5 top-[105px] shadow-lg border-2  border-gray-300  hover:shadow-[inset_0_-2px_4px_rgba(0,0,0,0.6)] rounded-lg text-center px-8  text-sm text-green-400 bg-white py-2'>Add</button>
                        </div>
                    </div >
                )
                )
