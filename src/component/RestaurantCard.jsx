...
const RestaurantCard = (props) => {
    ...
    return (
        <div >
            <div className='py-6 h-[25em]  w-72 hover:shadow-xl rounded-xl hover:shadow-gray-400 '>
                <div className='res-img mx-4 mb-4 flex justify-center pb-2 '>
                    <img
                        className=' text-center object-cover 
                        rounded-lg w-72 h-48' src={FOOD_IMG + cloudinaryImageId}></img>
                </div>
    ...
    return (props) => {
        ...
        return (
            <div className=''>
                ...
                <div className='bg-gradient-to-t from-gray-900 mx-[16px] relative bottom-[234px] rounded-b-lg '>
